...
task detectarCancelamento(){
	...
	while((ValorSensor[SonarCentro] > 20) && (ValorSensor[SonarDireito] > 20) && (ValorSensor[SonarEsquerdo] > 20)){
	}
...
void configurarMovimentacaoInicial(){
	...
	Menus[movInicial][5] = "Espaco Livre";
	Menus[movInicial][6] = "Espaco Livre";
	Menus[movInicial][7] = "Espaco Livre";
	Menus[movInicial][8] = "Espaco Livre";
}
